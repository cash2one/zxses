...
public class EmailSender {
    ...
    public static void main(String[] args) throws Exception {
    	...
    	EmailSender.send(new String[]{"1124715454@qq.com"}, "邮件测试xx", "<b>boleyn</b>",null , "text/html");
    }
    /**
     * 发送邮件
     * @param receiver 收件人
    ...
    public static void send(String[] receivers, String subject, String mailContent, File[] attachements, String mimetype) {
        ...
        Session session = Session.getDefaultInstance(props, new Authenticator() {
            protected PasswordAuthentication getPasswordAuthentication() {
            	...
            	//return new PasswordAuthentication("tlschoolsender@163.com","tlschooladmin");//登录用户名/密码
            	return new PasswordAuthentication(ApplicationConfig.get("email.sender"),ApplicationConfig.get("email.sender.password"));
            }
        });
        ...
        try {
            ...
            //mimeMessage.setFrom(new InternetAddress("tlschoolsender@163.com"));//发件人邮件
            mimeMessage.setFrom(new InternetAddress(ApplicationConfig.get("email.sender")));//发件人邮件
