...
public class RandImgCreater {
	private static final String CODE_LIST_STRONG = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz1234567890";
	private static final String CODE_LIST_SIMPLE = "1234567890";
	...
	public RandImgCreater(HttpServletResponse response) {
		...
		this.iNum = FONT_NUM;
		this.codeList = CODE_LIST_SIMPLE;
	}
	
	public RandImgCreater(HttpServletResponse response, boolean strong) {
		this.response = response;
		this.width = 13 * FONT_NUM + 12;
		this.iNum = FONT_NUM;
		if(strong)
			this.codeList = CODE_LIST_STRONG;
		else
			this.codeList = CODE_LIST_SIMPLE;
	}
	...
	public RandImgCreater(HttpServletResponse response, boolean strong,int iNum) {
		this(response,strong);
		this.response = response;
		this.width = 13 * iNum + 12;
		this.iNum = iNum;
		if(strong)
