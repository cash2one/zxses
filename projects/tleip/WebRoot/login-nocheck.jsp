		  ...
		  function send(event) {   
		   ...
		   $.post("login.do?method=login",{username:username,password:password,imagecode:imagecode},function(response){
			...
			function changeimage(){
				document.getElementById('codeImage').innerHTML="<img src='login.do?method=createImageCode' style='vertical-align: 0px' />";
			}
 	</script>
	</head>
		...
		<div class="logink">
			<table align="center" class="percentage50">
				...
				<tr>
					...
					<td align="left">
						<input type="text" name="imagecode" id="textfield3" value=""
							class="zdpic3" maxlength="4" />
						&nbsp;&nbsp;
						<span id="codeImage"><img
								src="login.do?method=createImageCode"
				...
				<tr>
					...
					<td align="left">
						&nbsp;&nbsp;
						<a href="javascript:changeimage()" class="imglink">看不清楚？ 换个验证码
						</a>
					</td>
				</tr>
