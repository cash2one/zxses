...
<html>
	...
	<frameset rows="125,*,21" id="ldy" name="ldy" cols="*" frameborder="no"
		...
		<frame src="<%=basePath%>login.do?method=topList" name="top" scrolling="no" noresize="noresize" id="top" />
		<frameset id="middle" cols="200,12,*" frameborder="no" border="0" framespacing="0">
			<frame src="<%=basePath%>login.do?method=leftList" name="left" noresize="noresize"  scrolling="auto" id="left" />
