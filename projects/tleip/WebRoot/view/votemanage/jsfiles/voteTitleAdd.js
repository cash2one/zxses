...
function addItem(){    
	...
	var itemHtml = "<div style=\"display:inline;\" id=\"item" + count + "\"><br/><span>选项" + count + "：</span><input type=\"text\" name=\"itemName\" id=\"itemName"+count+"\"/><input id=\"itemButton"+count+"\" class=\"removeButton\" type=\"button\" onclick=\"removeItem('"+count+"')\" value=\"删除选项\"/></div>";
