...
<html>
	...
	<script type="text/javascript">
       function add(){
        ...
        $.post("rightManage.do?method=updateRoleExist",{rolename:name},function(response){
						...
						<tr>
							<td>
								<table cellSpacing="0" cellPadding="0" border="0" width="97%"
									...
									<tr>
										<td>
											<html:form action="view/rightManage.do?method=addRole"
												method="post">
												<table class="table" cellSpacing="1" cellPadding="0"
													...
													<tr>
														...
														<td class="td_right">
															<html:text property="sysRole.roleName"></html:text>
														</td>
													</tr>
