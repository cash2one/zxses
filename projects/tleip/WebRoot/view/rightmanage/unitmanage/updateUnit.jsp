							...
							<tr>
								<td>
									...
									<tr>
										<td>
											系统管理-&gt;
											<span class="chuti lv">修改单位信息</span>${showMsg }
										</td>
										<td align="right">
							...
							<tr>
								<td>
									<table cellSpacing="0" cellPadding="0" border="0" width="97%"
										...
										<tr>
											<td>
											<html:form action="view/rightManage.do?method=updateUnit" method="post">
											    <html:hidden property="basicUnit.unitId"/>
												<table class="table" cellSpacing="1" cellPadding="0"
													...
													<tr>
														...
														<td class="td_right">															 
															 <html:textarea property="basicUnit.remark" style="height: 120px ; width:100%"></html:textarea>
														</td>											
													</tr>
												</table>
											</html:form>
