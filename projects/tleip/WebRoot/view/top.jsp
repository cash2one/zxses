...
<html>
	<head>
		...
		function changehead(headA){
		 ...
		 function goout(){
		      window.parent.location.href="<%=basePath%>login.do?method=loginOut";
		    }
		 function goindex(){
					...
					<table class="menutable">
						<tr>
							<logic:present name="moduleList">
								<logic:iterate id="m" name="moduleList">
									<td class="menu01">
										<a href="${m.url}&module_id=${m.moduleId}" target="left"
											class="linkbai" onclick="changehead(this)" name="headA">${m.moduleName}</a>
									</td>
								</logic:iterate>
							</logic:present>
						</tr>
