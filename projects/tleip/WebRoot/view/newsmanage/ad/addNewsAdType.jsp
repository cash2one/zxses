	...
	<head>
		...
		<script language="JavaScript" type="text/JavaScript"> 
			...
			function check(){
				...
				newsmanageForm.action = "<%=basePath%>view/newsmanage.do?method=addNewsAdType";
								...
								<td align="left" valign="top">
									<table class="pathbg">
										<tr>
											<td  height="24">
												新闻发布管理-&gt;
												<span class="lv chuti">广告类型新增</span>${showMsg }
											</td>
											<td align="right">
												...
												<table class="table" cellSpacing="1" cellPadding="0" width="100%" border="0" >
													<tr>
														...
														<td  class="td_right" width="50%">
															...
															<font color="#ff0000"><b>${newsItemBig.classId}&nbsp;&nbsp;[${newsItemBig.className}]</b></font>
														</td>
													</tr>
													<tr>
														<td  class="td_left" width="50%">
														...
														<td  class="td_right" width="50%">
															<input type="text" name="adTypeName" id="adTypeName" >
														</td>
													</tr>
													<tr>
														<td  class="td_left" width="50%">
														...
														<td class="td_right" width="50%">
															<select name="adTypeTag"  id="adTypeTag"  style="width: 150px; text-align: center">
													...
													<tr>
														...
														<td class="td_right" width="50%">
															<input type="text" name="adWidth" maxlength="4" id="adWidth" value="735"><font size="2"><em><font color="#c0c0c0">建议宽度:735</font></em></font>
														</td>
													</tr>
													<tr>
														<td class="td_left" width="50%">
														...
														<td class="td_right" width="50%">
															<input type="text" name="adHeight" maxlength="4" value="160" id="adHeight">
														</td>
													</tr>
												</table>
											</td>
