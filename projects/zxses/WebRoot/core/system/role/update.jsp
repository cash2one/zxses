...
<html>
	...
	<body class="centerbg">
		<s:form action="sysRole!updateSysRole.action" method="post">
			...
			<s:hidden name="sysRole.id"></s:hidden>
			<div class="editdiv">
					...
					<tr>
						...
						<td height="32" align="left">
							...
							<input name="button2" type="button" class="an" id="button2"
								value="返回"
								onclick="window.location.href='sysRole!listSysRole.action?theme=simple&paginate.offset=${paginate.offset }'" />
						</td>
					</tr>
				</table>
			</div>
