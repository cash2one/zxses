...
<html>
	<head>
		...
		<script type="text/javascript">
			function searchMan(){
				document.myform.action= 'view/misIReport!listMan.action';
				document.myform.target="_self";
		    	document.myform.submit();
			}
			
		    function misSegmentsPrint(actionUrl){
	...
	<body class="centerbg" onload="setFocusInput('${focusInputId }')">
		<jsp:include page="/core/header.jsp">
			<jsp:param name="buttons"
				value="打印--javascript:misSegmentsPrint('view/misIReport!mansPrint.action')" />
		</jsp:include>

		<s:form action="misIReport!listMan.action" method="post" id="myform"
			...
			<table id="mytable">
				...
				<s:iterator value="manufactures" status="i">
					<tr class="tr${i.index%2+1}" onMouseOver="this.className='cstd2'"
						...
						<td>
							<a
								href="view/misIReport!listNumMisSegment.action?manufacture.id=${id }"
						...
						<td>
							<a
								href="view/misIReport!entryInfoMan.action?manufacture.id=${id}&theme=simple&paginate.offset=${paginate.offset }"
								class="opertion">详情</a>
						</td>
					</tr>
				</s:iterator>
		...
		<jsp:include page="/tag/page/page.jsp" flush="true">
			<jsp:param name="url" value="view/misIReport!listMan.action" />
