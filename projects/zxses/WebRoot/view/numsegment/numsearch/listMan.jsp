...
<html>
	...
	<body class="centerbg" onload="setFocusInput('${focusInputId }')">
		...
		<s:form action="numSearch!listMan.action" method="post" id="myform">
			<s:hidden name="focusInputId"></s:hidden>
			<div class="queryheader">
				起始号：
				<s:textfield name="manufactureOp.staNumber" cssClass="zd1Solid"
					id="manStaNumber" cssStyle="width:17%"></s:textfield>
				&nbsp;&nbsp; 终止号：
				<s:textfield name="manufactureOp.endNumber" cssClass="zd1Solid"
					id="manEndNumber" cssStyle="width:17%" id="manEndNumber"></s:textfield>
				&nbsp;&nbsp;生产单号：
			...
			<table id="mytable">
				...
				<s:iterator value="manufactures" status="i">
					<tr class="tr${i.index%2+1}" onMouseOver="this.className='cstd2'"
						...
						<td>
							<a
								href="view/numSearch!listNumSegment.action?manufacture.id=${id }"
						...
						<td>
							<a
								href="view/numSearch!entryInfoMan.action?manufacture.id=${id}&theme=simple&paginate.offset=${paginate.offset }"
								class="opertion">详情</a>
						</td>
					</tr>
				</s:iterator>
		...
		<jsp:include page="/tag/page/page.jsp" flush="true">
			<jsp:param name="url" value="view/numSearch!listMan.action" />
