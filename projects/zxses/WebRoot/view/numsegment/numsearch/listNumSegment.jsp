	...
	<body class="centerbg" onload="setFocusInput('${focusInputId }')">
		<jsp:include page="/core/header.jsp">
			<jsp:param name="buttons"
				value="返回--view/numSearch!listMan.action?theme=simple" />
		</jsp:include>

		<s:form action="numSearch!listNumSegment.action" method="post"
			id="myform">
		...
		<jsp:include page="/tag/page/page.jsp" flush="true">
			<jsp:param name="url" value="view/numSearch!listNumSegment.action" />
