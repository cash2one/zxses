		...
		<div class="editdiv">
			<table class="edittable">
				...
				<tr>
					...
					<td class="tdright2zx">
						<s:textfield name="manuStaDate" cssClass="zd2Solid"
							readonly="true" />
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td height="32" align="left">
						<input name="button2" type="button" class="an" id="button2"
							value="返回"
							onclick="window.location.href='view/numIReport!listMan.action?theme=simple&paginate.offset=${paginate.offset }'" />
					</td>
				</tr>
			</table>
		</div>
