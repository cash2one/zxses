	...
	<body class="centerbg" onload="setFocusInput('${focusInputId }')">
		<jsp:include page="/core/header.jsp">
			<jsp:param name="buttons"
				value="录入缺失号--javascript:addNumMis('view/misAdd!listMis.action?theme=simple')" />
		</jsp:include>

		<s:form action="misAdd!listMan.action" method="post" id="myform">
			...
			<table id="mytable">
				...
				<s:iterator value="manufactures" status="i">
					<tr class="tr${i.index%2+1}" onMouseOver="this.className='cstd2'"
						...
						<td>
							<a href="view/misAdd!listMis.action?checkManIds=${id }"
						...
						<td>
							<a
								href="view/misAdd!entryInfoMan.action?manufacture.id=${id}&theme=simple&paginate.offset=${paginate.offset }"
								class="opertion">详情</a>
						</td>
					</tr>
				</s:iterator>
		...
		<jsp:include page="/tag/page/page.jsp" flush="true">
			<jsp:param name="url" value="view/misAdd!listMan.action" />
