...
public final class SQLCommandBuilder {
     ...
     * @return SQL语句的方法
     */
    public String getSQLCommand(SQLCommandType sqlCmdType, String tableName, String[] columnName, Object[] param, Hashtable<String, Object> condition) {

	// 校验参数的有效性，若无效则抛出异常
	try {
	    SQLValidateHelper.ValidateSQLAndParam(sqlCmdType, tableName, columnName, param, condition);
	...
	case SELECT:
		...
		sql.append((i < columnName.length - 1) ? (columnName[i] + "],\u0020[") : (columnName[i] + "]\u0020"));
	    }
	    // 拼接表名
	...
	if (condition != null && condition.size() != 0) {
		...
		sql.append((j < conditionName.length - 1) ? (conditionName[j] + "]\u0020=\u0020?\u0020And\u0020[") : (conditionName[j] + "]\u0020=\u0020?"));
	    }
	}
