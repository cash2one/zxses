					...
					<td valign="top">
						<table cellSpacing="0" cellPadding="0" border="0" width="100%"
							...
							<tr>
								<td>
								<!-- 修改form action路径 -->
								<html:form action="view/sysmodule.do?method=update" method="post">
									<input type="hidden" name="parentId" value="${sysModuleForm.parentId }"/>
									<!-- 主键id -->
									<input type="hidden" name="id" value="${sysModuleInfo.id }"/>
									<table cellSpacing="0" cellPadding="0" border="0" width="100%"
										align="center">
										<tr>
											<td>
												...
												<table class="table" cellSpacing="1" cellPadding="0"
													...
													<tr>
														...
														<td width="30%" class="td_right">
															<input type="text" name="name" value="${sysModuleInfo.name }" id="name" size="30" maxlength="20" />
														</td>
													</tr>
													<tr>
														<td width="20%" class="td_left">
														...
														<td width="30%" class="td_right">
															 <input type="text" name="sn" value="${sysModuleInfo.sn }" id="sn" size="30" maxlength="20" />
														</td>
													</tr>
													<tr>
														<td width="20%" class="td_left">
														...
														<td width="30%" class="td_right">
															  <input type="text" name="orderNo" value="${sysModuleInfo.orderNo }" id="orderNo" size="30" maxlength="20" />
														</td>
													</tr>
													<tr>
														<td width="20%" class="td_left">
														...
														<td width="30%" class="td_right">
															<input type="text" name="url" value="${sysModuleInfo.url }" id="url" size="30" maxlength="20" />
														</td>
													</tr>
												</table>
											</td>
