...
<html>
	...
	<body leftMargin=0 topMargin=0 marginwidth="0" marginheight="0"
		onload="MM_preloadimage('<%=basePath%>res/theme/blue/images/mainleftspico.gif','<%=basePath%>res/theme/blue/images/mainleftspico2.gif')">
		<div onclick=oa_tool1() align=center>
			<table cellSpacing=0 cellPadding=0 width="12" border=0 height="100%">
				<tr>
					<td width="12" align="center"
						background="<%=basePath%>res/theme/blue/images/main09.gif">
						<img src="<%=basePath%>res/theme/blue/images/mainleftspico.gif"
